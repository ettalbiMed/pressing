    ...
    <div className="bg-ivory text-text">
      ...
      <main className="mx-auto flex max-w-6xl flex-col gap-24 px-6 pb-24 pt-10">
        ...
        <section id="delivery" className="section-offset bg-white py-20 md:py-28" aria-labelledby="delivery-title">
          <div className="mx-auto max-w-[1240px] text-center" data-animate>
            <h2 id="delivery-title" className="font-display text-[3.4rem] font-semibold uppercase leading-none tracking-[0.04em] text-brand md:text-[5.15rem]">
              ITRI CLEAN
            </h2>
            <p className="mt-9 text-[1.2rem] uppercase italic tracking-[0.03em] text-brand/80 md:text-[2rem] md:leading-[1.15]">
            ...
            <h3 className="mt-20 text-[2rem] font-semibold leading-tight text-brand md:text-[3.35rem]">La propreté chez vous en 3 étapes...</h3>
            <p className="mt-6 text-xl text-text/80 md:text-[1.95rem]">3 étapes simples pour nettoyer vos articles</p>

            <div className="mt-20 grid grid-cols-1 gap-y-14 md:grid-cols-[1fr_auto_1fr_auto_1fr] md:items-start md:gap-x-6">
              <article className="mx-auto flex max-w-[18rem] flex-col items-center">
                <div className="flex h-[7.9rem] w-[7.9rem] items-center justify-center rounded-full bg-brand text-white shadow-soft/40">
                  <svg viewBox="0 0 48 48" className="h-[3.6rem] w-[3.6rem]" fill="none" stroke="currentColor" strokeWidth="2.4" aria-hidden="true">
                ...
                <h4 className="mt-8 whitespace-nowrap text-[2rem] font-semibold text-brand md:text-[2.05rem]">1-Commande</h4>
                <p className="mt-7 text-[1.85rem] leading-[1.42] text-text/90 md:text-[0.95rem]">
              ...
              <span className="hidden self-start md:mt-[10.5rem] md:block" aria-hidden="true">
                <svg viewBox="0 0 112 18" className="h-7 w-24 text-brand/65" fill="none" stroke="currentColor" strokeWidth="1.6">
              ...
              <article className="mx-auto flex max-w-[18rem] flex-col items-center">
                <div className="flex h-[7.9rem] w-[7.9rem] items-center justify-center rounded-full bg-brand text-white shadow-soft/40">
                  <svg viewBox="0 0 48 48" className="h-[3.6rem] w-[3.6rem]" fill="none" stroke="currentColor" strokeWidth="2.2" aria-hidden="true">
                ...
                <h4 className="mt-8 whitespace-nowrap text-[2rem] font-semibold text-brand md:text-[2.05rem]">2-Collecte</h4>
                <p className="mt-7 text-[1.85rem] leading-[1.42] text-text/90 md:text-[0.95rem]">
              ...
              <article className="mx-auto flex max-w-[18rem] flex-col items-center">
                <div className="flex h-[7.9rem] w-[7.9rem] items-center justify-center rounded-full bg-brand text-white shadow-soft/40">
                  <svg viewBox="0 0 48 48" className="h-[3.6rem] w-[3.6rem]" fill="none" stroke="currentColor" strokeWidth="2.1" aria-hidden="true">
                ...
                <h4 className="mt-8 whitespace-nowrap text-[2rem] font-semibold text-brand md:text-[2.05rem]">3-Livraison</h4>
                <p className="mt-7 text-[1.85rem] leading-[1.42] text-text/90 md:text-[0.95rem]">
